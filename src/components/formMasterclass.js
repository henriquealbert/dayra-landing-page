...
export default function FormMasterclass() {
  return (
    <>
      <form
      ...
      >
        ...
        <input id="pid" name="pid" type="hidden" value="16505417" />
        ...
        <img
          src="https://llimages.com/redirect/redirect.aspx?A=V&p=16505417&m=396391"
          style={{ display: 'none' }}
        />
      </form>
    </>
